...
namespace Abatab
{
    public class WebConfig
    {
            ...
            public static void Load(AbSession abSession)
            {
                ...
                abSession.AbatabMode              = Properties.Settings.Default.AbatabMode;
                ...
                abSession.AbatabEmailFromAddress  = Settings.Default.AbatabEmailFromAddress;
                abSession.AbatabEmailFromPassword = Settings.Default.AbatabEmailFromAddressPassword;
                abSession.AbatabEmailTestAddress  = Settings.Default.AbatabEmailTestAddress;
                abSession.AbatabEmailTestSubject  = Settings.Default.AbatabEmailTestSubject;
                abSession.AbatabEmailTestBody     = Settings.Default.AbatabEmailTestBody;
