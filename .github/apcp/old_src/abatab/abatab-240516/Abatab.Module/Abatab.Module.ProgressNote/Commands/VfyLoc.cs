...
{
    /// <summary>Parses the action component of the ProgressNote VfyLoc command.</summary>
    /// <remarks>
    ///     - The full name of the "VfyLoc" command is "Verify Location".<br></br>
    ///     - This class should not be modified unless a new action is added to the ProgressNote VfyLoc command.<br></br>
    ///     - When a new command is added to the ProgressNote VfyLoc command, you will need to add a new case to the <b>SendToCommand()</b> method.
    ///       <see href="https://github.com/spectrum-health-systems/Abatab-Documentation-Project">(more information)</see>.
    /// </remarks>
    public static class VfyLoc
    {
