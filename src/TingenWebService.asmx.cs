...
namespace TingenWebService
{
    ...
    public class TingenWebService : WebService
    {
        ...
        public OptionObject2015 RunScript(OptionObject2015 sentOptObj, string sentScriptParameter)
        {
            ...
            if (string.IsNullOrWhiteSpace(sentScriptParameter) || sentOptObj == null)
            {
            ...
            if (sentScriptParameter.ToLower().StartsWith("_p"))
            {
            ...
            {
                File.WriteAllText(@"C:\IT\something.success", sentScriptParameter);
